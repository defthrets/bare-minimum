...
namespace BareMinimum.Core
{
    ...
    /// <summary>
    /// File logger for BareMinimum.log.
    ///
    ...
    ///
    /// The display name and the file names are deliberately different things. BareMinimum.dll,
    /// BareMinimum.ini, BareMinimum.log and the folder beside them are PATHS -- renaming those
    /// breaks every install that exists. Name is the word people read, and it has a space in it
    /// precisely because it is never used to build a path.
    /// </summary>

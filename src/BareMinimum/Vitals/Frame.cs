...
namespace BareMinimum.Vitals
{
    ...
    internal sealed class Frame
    {
        ...
        public void Draw(Settings cfg, Gauge.Row row, float mapLeft, float mapWidth, float strength)
        {
            ...
            // ON THE FRAME'S OWN OPACITY, NOT THE ROW'S. See Settings.MinimapOpacity: the bars
            // are meant to be seen through and this is meant to be a hard edge with writing on
            // it, and they were sharing one number.
            //
            ...
            var k = Ink.Clamp01(cfg.MinimapOpacity) * strength;
